...
<body>
	...
	<header class="header container-fluid">
		...
		<img class="header-img" src="images\reel.png"> <a
			class="header-itemright" href="ShowMovieItemListAdminServlet">Movies</a>
	</header>
	...
	<section class="body-main">
		...
		<c:set var="selected" value="${MovieItem.genre}" scope="application" />

		<form name="editMovie" action="EditMovieItemServlet"
			...
			<table style="width: 100%">
				...
				<tr>
					<td colspan="4"><input type="text" name="title" id="mtitle"
						style="width: 815px; height: 35px" value="${MovieItem.title}"></td>
				</tr>
				<tr>
					<th class="edittable"><label for="mgross">Gross ($)</th>
				...
				<tr>
					<td><input type="text" style="height: 25px" id="mgross"
						name="gross" value="${MovieItem.boxOffice}"></td>
					<c:choose>
						<c:when test="${MovieItem.active}">
					...
					<td><input style="height: 25px; width: 200px" type="date"
						name="date" id="mdate"
						value="<fmt:formatDate pattern="dd/MM/yyyy" value="${MovieItem.dateOfLaunch}" />"></td>
					<td><select name="genre" id="genre" style="height: 25px">
							<option value="${MovieItem.genre}" selected>${selected}</option>
				...
				<tr>
					<td class="edittable"><input type="checkbox" id="hasteaser"
						...
						<c:if test="${MovieItem.hasTeaser}"> checked="checked"</c:if>>
