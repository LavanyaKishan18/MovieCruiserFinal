...
<body>
	...
	<section class="body-main">
		...
		<c:if test="${addFavouritesStatus}">
			<h1 style="color: #00b300; text-align: center;">Movie added to
				Favourites Successfully</h1>
		</c:if>
		<table width="100%">
			<tr>
			...
			<c:forEach var="item" items="${customerMovieItemList}">
				<tr>
					...
					<td><a href="AddToFavouritesServlet?movieId=${item.id}">Add
							to Favorite</a></td>
				</tr>
			</c:forEach>
		</table>
